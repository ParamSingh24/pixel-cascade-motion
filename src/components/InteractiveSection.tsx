          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {Object.entries(sections).map(([key, section]) => (
              ...
              >
                ...
                {/* Hover indicator */}
                <div className={`absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-0 h-1 bg-yellow-400 transition-all duration-300 ${
                  activeSection === key ? 'w-full' : 'group-hover:w-full'
                }`} />
              </div>
            ))}
          </div>
